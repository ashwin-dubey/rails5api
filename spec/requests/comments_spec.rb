...
RSpec.describe 'Comments API' do
  ...
  let!(:comments) { create_list(:comment, 20, blog_id: blog.id) }
  let(:blog_id) { blog.id }
  ...
  describe 'GET /blogs/:blog_id/comments' do
    before { get "/blogs/#{blog_id}/comments", params: {}, headers: headers }
  ...
  describe 'GET /blogs/:blog_id/comments/:id' do
    before { get "/blogs/#{blog_id}/comments/#{id}", params: {}, headers: headers }
  ...
  # Test suite for PUT /blogs/:blog_id/comments
  describe 'POST /blogs/:blog_id/comments' do
    let(:valid_attributes) { { description: 'Niceblog', created_by: '1' }.to_json }

    context 'when request attributes are valid' do
      before { post "/blogs/#{blog_id}/comments", params: valid_attributes, headers: headers }
    ...
    context 'when an invalid request' do
      before { post "/blogs/#{blog_id}/comments", params: {}, headers: headers }
  ...
  describe 'PUT /blogs/:blog_id/comments/:id' do
    let(:valid_attributes) { { description: 'veryniceblog' }.to_json }

    before { put "/blogs/#{blog_id}/comments/#{id}", params: valid_attributes, headers: headers }
    ...
    context 'when comment exists' do
      ...
      it 'updates the comment' do
        ...
        expect(updated_comment.description).to match(/veryniceblog/)
      end
    end
  ...
  describe 'DELETE /blogs/:id' do
    before { delete "/blogs/#{blog_id}/comments/#{id}", params: {}, headers: headers }
